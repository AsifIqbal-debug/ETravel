  ...
  return (
    <div className="bg-onyx min-h-screen pb-20">
      ...
      <div className="container-custom py-12">
        <div className="space-y-8 text-gray-300 leading-relaxed max-w-4xl mx-auto">
          <section>
          ...
          <section>
            <h2 className="text-2xl font-serif font-bold text-white mb-4">4. User Responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-serif font-bold text-white mb-4">5. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-serif font-bold text-white mb-4">6. Limitation of Liability</h2>
            <p>
