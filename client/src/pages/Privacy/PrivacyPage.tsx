    ...
    <div className="bg-gray-50 dark:bg-onyx min-h-screen pb-20 transition-colors duration-300">
      ...
      <div className="bg-white dark:bg-onyx-light border-b border-gray-200 dark:border-white/10 py-16 transition-colors duration-300">
        <div className="container-custom text-center">
          <h1 className="text-4xl font-serif font-bold text-gray-900 dark:text-white mb-6">Privacy Policy</h1>
      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white dark:bg-onyx-light p-6 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none transition-colors duration-300">
            <Shield className="text-primary w-10 h-10 mb-4" />
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Data Protection</h3>
            <p className="text-gray-600 dark:text-gray-400">We use industry-standard encryption to protect your sensitive data.</p>
          </div>
          <div className="bg-white dark:bg-onyx-light p-6 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none transition-colors duration-300">
            <Lock className="text-primary w-10 h-10 mb-4" />
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Secure Transactions</h3>
            <p className="text-gray-600 dark:text-gray-400">All payments are processed securely through certified payment gateways.</p>
          </div>
          <div className="bg-white dark:bg-onyx-light p-6 rounded-xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none transition-colors duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-400">We are transparent about the data we collect and how it is used.</p>
          </div>
        </div>

        <div className="space-y-8 text-gray-600 dark:text-gray-300 leading-relaxed">
          <section>
            <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-4">1. Information We Collect</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-4">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-4">3. Data Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-4">4. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-4">5. Updates to This Policy</h2>
            <p>
